...
export const SERVICES: Service[] = [
  {
    ...
    photoAlt: 'Mekanik mengangkat mesin sedan hitam dengan engine crane merah di studio putih.',
  ...
  },
  {
    ...
    photoAlt: 'Sedan abu-abu terangkat di lift biru, transmisi diturunkan ke transmission jack.',
  ...
  },
  {
    ...
    photoAlt: 'Mekanik menyambungkan selang mesin flushing ke sedan hitam dengan kap terbuka.',
  ...
  },
  {
    ...
    photoAlt: 'Mekanik memegang filter udara di depan hatchback putih dengan kap terbuka.',
  ...
  },
  {
    ...
    photoAlt: 'Alat tester injector dengan enam tabung ukur di samping SUV hitam.',
  ...
  },
  {
    ...
    photoAlt: 'Mekanik membaca hasil scan di tablet di samping SUV biru.',
  ...
  },
  {
    ...
    photoAlt: 'Mekanik melakukan coding lewat laptop yang tersambung ke sedan hitam.',
  ...
  },
  {
    ...
    photoAlt: 'Mekanik menyolder papan sirkuit ECU di troli biru, SUV silver di belakang.',
  ...
  },
  {
    ...
    photoAlt: 'Roda terpasang di mesin balancing di depan SUV hitam.',
  ...
  },
  {
    ...
    photoAlt: 'Mesin servis AC dengan selang merah dan biru tersambung ke mobil putih.',
    car: { model: 'mini-countryman-2017', paint: 'white' },
    scene: 'ac-cold-air',
  },
  {
    ...
    photoAlt: 'Mekanik memoles pintu mobil hitam dengan mesin poles.',
    car: { model: 'range-rover-sport-2018', paint: 'black' },
  ...
  },
  {
    ...
    photoAlt: 'Troli berisi kotak sparepart di depan sedan hitam.',
    car: { model: 'bmw-3-g20', paint: 'black' },
    scene: 'parts-stack',
  },
  {
    ...
    photoAlt: 'Mekanik membuka kardus kiriman sparepart di depan SUV abu-abu.',
    car: { model: 'mercedes-e63-wagon-s213', paint: 'graphite' },
    scene: 'import-arc',
  },
  {
    ...
    photoAlt: 'Truk towing flatbed menurunkan SUV hitam di studio putih.',
    car: { model: 'land-rover-defender-110', paint: 'black' },
