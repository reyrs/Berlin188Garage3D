    ...
    >
      ...
      <header className="fixed inset-x-0 top-0 z-30 flex h-16 items-center justify-between px-4 sm:px-8 bg-gradient-to-b from-[#08080a]/90 via-[#08080a]/40 to-transparent pointer-events-none">
        <div className="flex items-center gap-6 pointer-events-auto">
          ...
          <div className="hidden sm:inline-flex items-center gap-2 rounded-full bg-cloud-white/5 px-3 py-1 border border-cloud-white/10 text-xs text-cloud-white/80">
            <span className="h-1.5 w-1.5 rounded-full bg-berlin-red animate-pulse" />
            <span>Studio 3D Configurator</span>
          </div>
        </div>
